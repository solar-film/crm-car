...
const CACHE_NAME = 'car-crm-mobile-full-v8';
const SHELL_FILES = ['./', './index.html', './styles.css?v=7', './core.js?v=7', './app.js?v=8', './manifest.webmanifest?v=7', './icon-192.png', './icon-512.png'];

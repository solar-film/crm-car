...
const CACHE_NAME = 'car-crm-mobile-full-v12';
const SHELL_FILES = ['./', './index.html', './styles.css?v=7', './core.js?v=10', './app.js?v=12', './manifest.webmanifest?v=7', './icon-192.png', './icon-512.png'];
